...
const projects: Project[] = [
  {
    ...
    description:
      "Carbon intelligence platform with OCR-assisted reporting workflows.",
  },
  {
    name: "AegisFlow",
    tags: "FinTech SaaS · LSTM forecasting · Pakistani market",
    description:
      "Forecasting and decision support product tailored for local financial operators.",
  },
  {
    name: "visa-path",
    tags: "B2C SaaS · Visa strategy · Digital nomads",
    description:
      "Guided visa planning experience for individuals building global mobility plans.",
  },
];
